exports.BettingAPINGException = {
	...
	TOO_MANY_REQUESTS: {
		...
		desc:
			"There are too many pending requests (e.g. a listMarketBook) with Order/Match projections to 3 concurrent requests." +
	...
	TIMEOUT_ERROR: {
		val: "TIMEOUT_ERROR",
		desc:
			"The internal call to downstream service timed out. Please note: If a TIMEOUT_ERROR error occurs on a placeOrders/replaceOrders request " +
