...
exports.RunnerStatus = {
	...
	REMOVED_VACANT: {
		val: "REMOVED_VACANT",
		desc:
			"REMOVED_VACANT applies to Greyhounds. Greyhound markets always return a fixed number of runners (traps). " +
	...
	HIDDEN: {
		val: "HIDDEN",
		desc:
			"The selection is hidden from the market.  This occurs in Horse Racing markets were runners is hidden when it is doesn’t hold an official entry following an entry stage. " +
...
exports.Side = {
	BACK: {
		val: "BACK",
		desc:
			"To back a team, horse or outcome is to bet on the selection to win. For LINE markets a Back bet refers to a SELL line. " +
			"A SELL line will win if the outcome is LESS THAN the taken line (price)"
	},
	LAY: {
		val: "LAY",
		desc:
			"To lay a team, horse, or outcome is to bet on the selection to lose. For LINE markets a Lay bet refers to a BUY line. " +
...
exports.OrderStatus = {
	PENDING: {
		val: "PENDING",
		desc:
			"An asynchronous order is yet to be processed. Once the bet has been processed by the exchange (including waiting for any in-play delay), " +
	...
	EXPIRED: {
		val: "EXPIRED",
		desc:
			"The order is no longer available for execution due to its time in force constraint. In the case of FILL_OR_KILL orders, " +
...
exports.ExecutionReportErrorCode = {
	ERROR_IN_MATCHER: {
...
exports.InstructionReportStatus = {
	SUCCESS: {
		val: "SUCCESS",
	...
	TIMEOUT: {
		val: "TIMEOUT",
		desc:
			"The instruction timed out & the status of the bet is unknown. " +
			"If a TIMEOUT error occurs on a placeOrders/replaceOrders request, you should check listCurrentOrders to verify the status of your bets before placing further orders. " +
...
exports.InstructionReportErrorCode = {
	INVALID_BET_SIZE: {
...
exports.GroupBy = {
	...
	SIDE: {
		val: "SIDE",
		desc:
			"An averaged roll up of settled P&L, and number of bets, on the specified side of a specified selection with a specified market, that are either settled or voided"
	},
	BET: {
		val: "BET",
...
exports.BetStatus = {
	SETTLED: {
		val: "SETTLED",
		desc: "A matched bet that was settled normally"
	},
	VOIDED: {
		val: "VOIDED",
		desc: "A matched bet that was subsequently voided by Betfair, before, during or after settlement"
	},
	LAPSED: {
		val: "LAPSED",
		desc: "Unmatched bet that was cancelled by Betfair (for example at turn in-play)"
	},
	CANCELLED: {
		val: "CANCELLED",
		desc: "Unmatched bet that was cancelled by an explicit customer action"
	}
}
...
exports.BetTargetType = {
	...
	PAYOUT: {
		val: "PAYOUT",
		desc: "The total payout requested on a LimitOrder"
	}
}

exports.PriceLadderType = {
	CLASSIC: {
		val: "CLASSIC",
		desc: "Price ladder increments traditionally used for Odds Markets"
	},
	FINEST: {
		val: "FINEST",
		desc: "Price ladder with the finest available increment, traditionally used for Asian Handicap markets"
	}
}

exports.BettingOperations = {
