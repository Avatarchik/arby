...
export default [
	...
	//
	// This is merging;
	// - ASIAN_HANDICAP_DOUBLE_LINE: 'Team A (+0.5/+1.0)'
	// - ASIAN_HANDICAP_SINGLE_LINE: 'Team A (+0.5)'
	//
	// The difference being the stake is split on the double lines but whole on a single
	{
