...
export default [
	 ...
	 */
	{
		...
		potentialTypes: [
			...
			"EACH_WAY",
			"ROUND_LEADER",
			// Tennis - I thought this would have been correct score market but apparently not...
			"SET_BETTING",
			// Cricket
			"SERIES_WINNER",
			"TOP_BATSMAN"
	...
	// +0.5 or -0.5
	//
	// These markets only have 2 outcomes (win/lose - as you can't have half a point)
	{
		actualType: "HALF_LINE_ASIAN_HANDICAP", // This is when there are only 2 runners (Team A/Team B)
		potentialTypes: [
	...
	// +0.5/1.0 or +0.75
	//
	// According to this site: https://www.sbo.net/strategy/asian-handicap-betting/, both of the above representations are the same
	// They will both split your stake...half to the lower value (0.5) & the other to the higher value (1.0)
	// Bookies can represent these differently. Betfair, for example, represents them on their exchange UI as '0.5 & 1.0' but data is given in the API as 0.75
	// Betfair also refers to these as ASIAN_HANDICAP_DOUBLE_LINE (I imagine because the stake is split...)
	{
		actualType: "QUARTER_LINE_ASIAN_HANDICAP",
		potentialTypes: []
	},
	// For example:
	// +1 or -1
	//
	// These markets have 3 possible outcomes (win/lose/push)
	//
	...
	//
	// An ASIAN_HANDICAP_SINGLE_LINE with a WHOLE number (Team A +1) is handled by this market
	{
		actualType: "FULL_LINE_ASIAN_HANDICAP",
		potentialTypes: [
			// Football
			"TEAM_A_1",
			"TEAM_A_2",
	...
	// What is the difference between these and ONE_TWO betting when going off the number of runners?
	{
		...
		potentialTypes: [
			...
			"OVER_UNDER_65_CARDS",
			"OVER_UNDER_25_CARDS",
			"TOTAL" // This is Matchbook specific
		]
	},
	{
		...
		potentialTypes: [
			...
			"TOTAL_GOALS",
			"CORRECT_SCORE2",
			"FIRST_GOAL_ODDS", // Weird one...has runners of time ranges when the 1st goal will be...
			// Tennis
			"SET_CORRECT_SCORE",
			// Cricket
			"TOTAL_SIXES",
