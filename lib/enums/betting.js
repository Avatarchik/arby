...
export const TimeInForce = {
    FILL_OR_KILL: {
        val: "FILL_OR_KILL",
        desc: "Execute the transaction immediately and completely (filled to size or between minFillSize and size) or not at all (cancelled). "
            + "For LINE markets Volume Weighted Average Price (VWAP) functionality is disabled"
    }
};

export const BetTargetType = {
    BACKERS_PROFIT: {
        val: "BACKERS_PROFIT",
        desc: "The payout requested minus the calculated size at which this LimitOrder is to be placed. BetTargetType bets are invalid for LINE markets"
    },
    PAYOUT: {
        val: "PAYOUT",
